...
public class ChatService {
    ...
    public String procesarMensaje(String mensajeUsuario) {
        ...
        if (mensaje.contains("hola") || mensaje.contains("buenos")) {
            ...
            respuesta.append(
                    "Nuestros precios varían según el producto y su calidad, por favor indique el producto que desea consultar.\n");
        } else if (mensaje.contains("stock")) {
            respuesta.append(
                    "Nuestros stock varía según el producto y su calidad, por favor indique el producto que desea consultar.\n");
        } else {
